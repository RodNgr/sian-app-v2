...
@Component({
  selector: 'app-lista-cuadratura-mall',
  templateUrl: './lista-cuadratura-mall.component.html',
  styleUrls: ['./lista-cuadratura-mall.component.css']
})
export class ListaCuadraturaMallComponent implements OnInit {
  ...
  public exportXLS(): void {
    ...
    let worksheet = workbook.addWorksheet('Proceso Envío Información Mall');

    // Título del archivo
    worksheet.addRow(['']);
    worksheet.addRow(['Listado de Procesos Envío Información Mall']);
    worksheet.addRow(['']);
    ...
    workbook.xlsx.writeBuffer().then((data) => {
      ...
      fs.saveAs(blob, 'Proceso_Informacion_Mall.xlsx');
    });
  }
