...
@Component({
  selector: 'app-cuadratura-agregador-didi',
  templateUrl: './cuadratura-agregador-didi.component.html',
  styleUrls: ['./cuadratura-agregador-didi.component.css']
})
export class CuadraturaAgregadorDidiComponent implements OnInit {
  ...
  public cancelar(): void {
    this.router.navigateByUrl('/home/cuadratura/lista-cuadratura-didi');
  }
    ...
    if (promiseList.length) {
      forkJoin(promiseList).subscribe(
        files => {
          ...
          this.proceso.deProceso = 'DIDI ' + this.marcaSelected.abreviatura + ' ' + 
