...
@Component({
  selector: 'app-lista-cuadratura-agregador',
  templateUrl: './lista-cuadratura-agregador.component.html',
  styleUrls: ['./lista-cuadratura-agregador.component.css']
})
export class ListaCuadraturaAgregadorComponent implements OnInit, OnDestroy {
  ...
  public newProceso(): void {
    if (this.type === 1) {
      this.router.navigateByUrl('/home/cuadratura/pedidos-rappi')
    }
  }
  ...
  public exportXLS(): void {
    ...
    let worksheet = workbook.addWorksheet('Proceso Cuadratura Rappi');

    // Título del archivo
    worksheet.addRow(['']);
    worksheet.addRow(['Listado de Procesos de Cuadratura Rappi']);
    worksheet.addRow(['']);
    ...
    workbook.xlsx.writeBuffer().then((data) => {
      ...
      fs.saveAs(blob, 'Proceso_Cuadratura_Rappi.xlsx');
    });
  }
