...
@Component({
  ...
  templateUrl: './cuadratura-agregador.component.html',
  styleUrls: ['./cuadratura-agregador.component.css']
})
export class CuadraturaAgregadorComponent implements OnInit {
  ...
  public cancelar(): void {
    this.router.navigateByUrl('/home/cuadratura/lista-cuadratura-rappi');
  }
    ...
    if (promiseList.length) {
      forkJoin(promiseList).subscribe(
        files => {
          ...
          this.proceso.deProceso = 'RAPPI ' + this.marcaSelected.abreviatura + ' ' + 
